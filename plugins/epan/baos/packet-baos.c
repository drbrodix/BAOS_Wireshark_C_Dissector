...
dissect_baos_heur(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree, void *data _U_)
{
	...
	proto_tree_add_item(baos_payload_tree, hf_baos_baos_mainservice, tvb, BAOS_START_INDEX, 1, ENC_BIG_ENDIAN);
	proto_tree_add_item(baos_payload_tree, hf_baos_baos_subservice, tvb, BAOS_START_INDEX + 1, 1, ENC_BIG_ENDIAN);
...
{
	heur_dissector_add("usb.bulk", dissect_baos_heur, "BAOS", "baos", proto_baos, HEURISTIC_ENABLE);
}
